...
---@param x number Can be of three types: </br>
---number X component
...
---@param theta number theta Angle of the point (in radians)
---@return Vec2 out
...
--- Clone a vector.
---@param a vec2 a Vector to be cloned
---@return Vec2 out
...
--- Add two vectors.
---@param a vec2 a Left hand operand
---@param b vec2 b Right hand operand
---@return Vec2 out
...
--- Treats the two vec2s as a 2x2 matrix and calculates the determinate
---@ vec2param a
---@param b 
---@return 
...
---@param Digits precision after the decimal (integer if unspecified)
...
---@param a vec2 Vector to convert.
---@param z number the new z component, or nil for 0
